...
const Nav = () => {
  ...
  return (<nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed h-max botton-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen  ">
    {/* inner */}
